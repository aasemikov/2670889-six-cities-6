...
// Пример с обработкой ошибок загрузки изображений
const OfferGalleryWithErrorHandling: React.FC<GalleryProps> = ({ images }) => (
...
export const WithErrorHandling: Story = {
  render: (args) => <OfferGalleryWithErrorHandling {...args} />,
  args: {
    images: [
      'https://broken-link-1.com/image.jpg',
      'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800&auto=format&fit=crop',
      'https://broken-link-2.com/image.jpg',
    ],
  },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Галерея с обработкой ошибок загрузки изображений.',
      },
    },
  },
};